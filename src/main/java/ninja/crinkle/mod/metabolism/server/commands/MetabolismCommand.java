...
import ninja.crinkle.mod.lib.common.util.StringUtil;
...
public class MetabolismCommand {
    ...
    private <T extends Comparable<? super T>> int setValue(CommandSourceStack source, Setting<T, Player> setting,
    ...
    private <T extends Comparable<? super T>> ArgumentBuilder<CommandSourceStack, ?> command(Setting<T, Player> setting) {
